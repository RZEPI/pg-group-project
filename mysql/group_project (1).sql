...
--
-- Host: db
-- Generation Time: Sty 08, 2024 at 02:06 PM
...
--
-- Struktura tabeli dla tabeli `Hints`
--
...
--
ALTER TABLE `Hints`
  ADD CONSTRAINT `Hints_ibfk_1` FOREIGN KEY (`question_id`) REFERENCES `Questions` (`question_id`);
COMMIT;
